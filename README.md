...
**Hello Rails Backend**integration that bridges the gap between the Ruby on Rails backend and the React frontend.
...
- [Frontend link](https://github.com/Kel-nana/hello-react-front-end)
...
```
  git clone git@github.com:Kel-nana/Final_group_capstone_backend.git
...
Feel free to check the [issues page](https://github.com/Kel-nana/hello-react-front-end/issues).
...
This project is [MIT](https://github.com/Kel-nana/hello-react-front-end/blob/main/LICENSE) licensed.
